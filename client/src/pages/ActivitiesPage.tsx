  ...
  useEffect(() => {
    const fetchActivities = async () => {
      try {
        ...
        const transformedActivities = Array.isArray(items) ? items.map(transformActivityData) : [];
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <span
                      className={`px-2 py-1 text-xs font-medium rounded-full ${activity.iconColor}`}
                    >
