...
const ExpensesPage: React.FC = () => {
  ...
  type SortBy = 'createdAt' | 'expenseDate' | 'amount' | 'type' | 'status';
  ...
  const sorted = [...filtered].sort((a, b) => {
    ...
    const getVal = (e: Expense) => {
      switch (sortBy) {
        case 'expenseDate': return e.expenseDate || '';
        case 'amount': return e.amount || 0;
        case 'type': return e.type || '';
        case 'status': return e.status || '';
        case 'createdAt': default: return e.createdAt || '';
      }
    };
    const va = getVal(a);
    const vb = getVal(b);
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 mobile-card-view table-fixed">
                  <thead className="bg-gray-50 dark:bg-gray-900">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-start text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Submitted By</th>
                      <th className="px-6 py-3 text-start text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {pageItems.map((expense) => (
                      <tr key={expense.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap" data-label="Amount">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap" data-label="Submitted By">
                          <div className="text-sm text-gray-900 dark:text-white flex items-center">
