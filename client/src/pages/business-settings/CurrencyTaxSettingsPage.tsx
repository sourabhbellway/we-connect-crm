...
const CurrencyTaxSettingsPage: React.FC = () => {
  ...
  const { taxSettings, updateTaxSettings, isLoading, refreshBusinessSettings } =
    useBusinessSettings();
            ...
            {loadingCurrencies ? (
              ...
              <div className="space-y-3">
                {currencies.map((currency) => (
                  <div
                    key={currency.id}
                    className="p-4 border border-gray-100 dark:border-gray-800 rounded-xl bg-white dark:bg-gray-800/50 flex items-center justify-between hover:border-indigo-500/30 transition-colors"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Rate: 1 USD = {currency.exchangeRate} {currency.code}
                        </p>
                      </div>
                    </div>
            ...
            {loadingTaxes ? (
              ...
              <div className="space-y-3">
                {taxes.map((tax: Tax) => (
                  <div
                    key={tax.id}
                    className="p-4 border border-gray-100 dark:border-gray-800 rounded-xl bg-white dark:bg-gray-800/50 flex items-center justify-between hover:border-blue-500/30 transition-colors"
                  >
                    <div>
                      <div className="flex items-center gap-2">
                        <p className="font-semibold text-gray-900 dark:text-white">
                ...
                {taxes.length === 0 && (
                  <div className="text-center py-8 border-2 border-dashed border-gray-100 dark:border-gray-800 rounded-xl">
                    <p className="text-sm text-gray-500">
                      No tax rates found. Click "Add New Rate" to get started.
                    </p>
                  </div>
                )}
              </div>
            ...
            <form onSubmit={handleSaveCurrency} className="p-6 space-y-5">
              ...
              <div>
                ...
                <p className="mt-1.5 text-[11px] text-gray-500 italic">
                  Enter how much of this currency equals 1 US Dollar.
                </p>
              </div>
                ...
                <div className="flex flex-col gap-3">
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <div className="relative flex items-center">
                      ...
                      />
                      <svg
                        className="absolute h-3.5 w-3.5 text-white opacity-0 peer-checked:opacity-100 transition-opacity pointer-events-none left-0.5"
