...
export const NotificationPreferencesPage: React.FC = () => {
  ...
  const notificationTypes = [
    ...
    },
    {
      key: "clientReply",
      label: "Client Reply",
      description: "When a client responds via email or WhatsApp",
    },
    { key: "paymentAdded", label: "Payment Added", description: "When a new payment is recorded" },
    {
      key: "paymentUpdated",
      label: "Payment Updated",
      description: "When payment information is modified",
    },
    {
      key: "taskAssigned",
    ...
    { key: "taskDue", label: "Task Due", description: "When your task is due soon" },
    {
      ...
      description: "When a meeting is scheduled with you",
    },
    ...
    { key: "dealLost", label: "Deal Lost", description: "When a deal is marked as lost" },
    {
      ...
      description: "When a quotation is sent to a client",
    },
    {
    ...
    <div className="p-6  mx-auto space-y-6">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Do Not Disturb</h2>
            <p className="text-sm text-gray-600 dark:text-gray-400">
