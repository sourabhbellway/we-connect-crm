...
import { LeadStatus } from '../../features/business-settings/types';

const LeadStatusesPage: React.FC = () => {
    const navigate = useNavigate();
    const {
        leadStatuses, addLeadStatus, updateLeadStatus, deleteLeadStatus, isLoading
    } = useBusinessSettings();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (editingId) {
                await updateLeadStatus(editingId, formData);
    ...
    const handleDelete = async (id: string) => {
        if (window.confirm('Are you sure you want to delete this status? This may affect leads using it.')) {
            try {
    ...
    return (
        <div className="space-y-6 p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                Configure dynamic statuses for leads
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div>
                    {isEditing ? (
                        <Card className="sticky top-6 border-2 border-blue-100 dark:border-blue-900/30">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full p-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none"
                                            />
                                        </div>
                                    </div>
                        ...
                        <Card className="bg-blue-50/50 dark:bg-blue-900/10 border-dashed border-2 border-blue-200 dark:border-blue-800">
                            <CardContent className="p-8 text-center">
                                <Tag className="w-12 h-12 text-blue-200 dark:text-blue-800 mx-auto mb-4" />
                                <h4 className="font-bold text-gray-900 dark:text-white mb-2">Management</h4>
                                <p className="text-xs text-gray-500 dark:text-gray-400 mb-6">
                                    Select a status to edit or click "Add Status" to create a new one. These statuses are used for leads.
                                </p>
                                <Button
                                    variant="OUTLINE"
                                    size="SM"
