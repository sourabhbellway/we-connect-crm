...
const LeadStatusesPage: React.FC = () => {
  ...
  const { leadStatuses, addLeadStatus, updateLeadStatus, deleteLeadStatus, isLoading } =
    useBusinessSettings();
  ...
  const handleDelete = async (id: string) => {
    if (
      window.confirm("Are you sure you want to delete this status? This may affect leads using it.")
    ) {
      try {
