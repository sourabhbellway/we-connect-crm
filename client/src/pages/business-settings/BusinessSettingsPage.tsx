      ...
      items: [
        {
          ...
          path: "/users",
          permission: PERMS.USER.READ,
        },
        {
          name: "Roles & Permissions",
          description: "Define roles and assign permissions",
          path: "/roles",
          permission: PERMS.ROLE.READ,
        },
        {
          name: "Teams",
          description: "Manage teams and reporting structures",
          path: "/business-settings/teams",
          permission: PERMS.TEAM.READ,
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          description: "Name, address, logo, GST details",
          path: "/business-settings/company",
          permission: PERMS.BUSINESS_SETTINGS.COMPANY.READ,
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          description: "Primary currency, exchange rates",
          path: "/business-settings/currency",
          permission: PERMS.BUSINESS_SETTINGS.CURRENCY.READ,
        },
      ],
    },
    {
      ...
      items: [
        {
          name: "Lead Sources",
          description: "Manage lead source options",
          path: "/business-settings/lead-sources",
          permission: PERMS.BUSINESS_SETTINGS.LEAD_SOURCE.READ,
        },
        {
          name: "Lead Form Fields",
          description: "Configure lead form fields - add, hide, show, make required",
          path: "/business-settings/lead-fields",
          permission: PERMS.BUSINESS_SETTINGS.FIELD_CONFIG.READ,
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          permission: PERMS.INDUSTRY.READ,
        },
      ],
    },
    {
      id: "call-outcomes",
      name: "Call Outcomes",
      description: "Customizable call results and log statuses",
      icon: <Workflow className="w-6 h-6" />,
      color: "bg-blue-500",
      items: [
        {
          name: "Call Outcomes Management",
          description: "Configure dynamic call log outcomes",
          path: "/business-settings/lead-statuses",
          permission: PERMS.BUSINESS_SETTINGS.DEAL_STATUS.READ,
        },
      ],
    },
    {
      ...
      name: "Lead Status",
      description: "Customizable lead stages for your pipeline",
      icon: <Workflow className="w-6 h-6" />,
      color: "bg-indigo-500",
      items: [
        {
          name: "Lead Status Management",
          description: "Configure dynamic lead status stages",
          path: "/business-settings/lead-status-management",
          permission: PERMS.BUSINESS_SETTINGS.LEAD_STATUS.READ,
        },
      ],
    },
    {
      ...
      items: [
        {
          name: "Deal Stage Management",
          description: "Configure dynamic deal stages",
      ...
      items: [
        {
          ...
          description: "Invoice formats and layouts",
          path: "/business-settings/invoice-templates",
          permission: PERMS.BUSINESS_SETTINGS.TEMPLATES.EMAIL.READ,
        }, // Assuming email templates for now
        {
          name: "Document Numbering",
          description: "Configure prefixes, suffixes, and numbering formats",
          path: "/business-settings/numbering",
          permission: PERMS.BUSINESS_SETTINGS.NUMBERING.READ,
        },
        {
          name: "Terms & Conditions",
          description: "Legal terms and conditions templates",
          path: "/business-settings/terms-and-conditions",
          permission: PERMS.BUSINESS_SETTINGS.TEMPLATES.TERMS.READ,
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          description: "Email, SMS, WhatsApp preferences",
          path: "/business-settings/notifications",
          permission: PERMS.NOTIFICATION.READ,
        },
      ],
    },
      ...
      items: [
        {
          ...
          permission: PERMS.COMMUNICATION.READ,
        },
        {
          name: "Lead Integrations",
          description: "Meta Ads, IndiaMart, TradeIndia integrations",
          path: "/business-settings/integrations/leads",
          permission: PERMS.BUSINESS_SETTINGS.INTEGRATIONS.READ,
        },
        {
          name: "Communication APIs",
          description: "WhatsApp, SMS, Email gateways",
          ...
          >
            <CardHeader className="pb-3">
              <div className="flex items-start gap-4">
                <div
                  className={`p-3 ${category.color} rounded-xl text-white group-hover:scale-110 transition-transform duration-300`}
                >
                  {category.icon}
                </div>
                <div className="flex-1">
