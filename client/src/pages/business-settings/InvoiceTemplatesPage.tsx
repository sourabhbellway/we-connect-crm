...
const InvoiceTemplatesPage: React.FC = () => {
  ...
  const { companySettings, updateCompanySettings, currencySettings, isLoading } =
    useBusinessSettings();
  ...
  const templates = [
    ...
    {
      id: "template1",
      name: "Values - Standard Left",
      description: "Clean layout with logo on the left",
      type: "standard-left",
    },
    {
      id: "template2",
      name: "Classic - Logo Right",
      description: "Traditional layout with logo on the right",
      type: "classic-right",
    },
    {
      id: "template3",
      name: "Bold Header",
      description: "Full-width colored header with green theme",
      type: "bold-header",
    },
    {
      id: "template5",
      name: "Minimalist",
      description: "Simple, data-focused black & white",
      type: "minimalist",
    },
  ];
  ...
  const getPreviewUI = (type: string) => {
    const BaseDoc = ({
      ...
      <div
        className={`bg-white rounded shadow-sm w-full h-full flex flex-col overflow-hidden text-gray-800 relative ${className}`}
      >
        {children}
      </div>
    );
    ...
    const NotesSection = () => (
      <div className="mt-auto pt-4 border-t border-gray-100 pb-2">
        <div className="text-[7px] font-bold text-gray-400 uppercase tracking-wider mb-1">
          Notes & Terms
        </div>
        <div className="text-[6px] text-gray-400 line-clamp-2 italic">
            ...
            <div className="flex-1">
              ...
              <div className="flex text-[8px] py-1.5 px-2 border-b border-gray-50">
                ...
                <div className="w-20 text-right font-bold">
                  {currencySettings?.symbol || "₹"}50,000
                </div>
              </div>
            </div>
          ...
          <BaseDoc className="p-6 text-[9px]">
            ...
            <div className="flex-1">
              ...
              <div className="flex py-2 px-2 border-b border-gray-100">
                ...
                <div className="w-20 text-right font-bold">
                  {currencySettings?.symbol || "₹"}35,000
                </div>
              </div>
            </div>
          ...
          <BaseDoc className="p-6 text-[9px] font-sans text-gray-800">
            ...
            <div className="flex-1">
              ...
              <div className="flex text-[8px] py-2 px-2 border-b border-gray-100 bg-teal-50/30">
                ...
                <div className="w-16 text-right font-bold text-teal-700">
                  {currencySettings?.symbol || "₹"}20,000
                </div>
              </div>
              <div className="flex text-[8px] py-2 px-2 border-b border-gray-100">
                ...
                <div className="w-10 text-center">1</div>
                <div className="w-16 text-right font-bold text-teal-700">
                  {currencySettings?.symbol || "₹"}25,000
                </div>
              </div>
            </div>
          ...
          <BaseDoc className="p-8 border-[2px] border-gray-900 text-[9px] flex flex-col">
            ...
            <div className="flex-1">
              ...
              <div className="flex mb-2">
                ...
                <div className="w-20 text-right font-bold">
                  {currencySettings?.symbol || "₹"}60,000
                </div>
              </div>
            </div>
            ...
            return (
              <div
                ...
                className={`group relative cursor-pointer transition-all duration-300 transform hover:-translate-y-1 ${
                  isSelected
                    ? "ring-2 ring-blue-500 ring-offset-2 dark:ring-offset-gray-900 rounded-xl"
                    : ""
                }`}
          ...
          <CardContent className="p-4 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 dark:text-blue-300">
                The selected template will be automatically applied to all PDF invoices and
                quotations generated from the system. content layout and branding will be adjusted
