        ...
        {LOG_CATEGORIES.map((cat) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2.5 px-6 py-2.5 rounded-xl font-bold text-sm transition-all whitespace-nowrap ${
                isActive
                ...
                <div className="divide-y divide-gray-50 dark:divide-slate-800">
                  {activities.map((activity) => {
                    ...
                    return (
                      <div
                        key={activity.id}
                        className="p-6 hover:bg-gray-50/50 dark:hover:bg-slate-800/30 transition-all group"
                      >
                        <div className="flex items-start gap-5">
                          <div
                            className={`p-3 rounded-2xl bg-white dark:bg-slate-800 shadow-sm border border-gray-100 dark:border-slate-700 group-hover:scale-110 transition-transform ${activity.iconColor}`}
                          >
                            <Icon size={24} />
                          </div>
                    ...
                    <tbody className="divide-y divide-gray-50 dark:divide-slate-800">
                      {callLogs.map((log) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-5">
                            <div className="flex items-center justify-center">
                              {log.callType === "INBOUND" ? (
                                <div
                                  className="bg-green-100 dark:bg-green-900/30 p-2 rounded-lg text-green-600 cursor-help"
                                  title="Inbound Call"
                                >
                                  <ArrowLeft size={16} />
                                </div>
                                ...
                                <div
                                  className="bg-blue-100 dark:bg-blue-900/30 p-2 rounded-lg text-blue-600 cursor-help"
                                  title="Outbound Call"
                                >
                                  <ArrowRight size={16} />
                                </div>
                          ...
                          <td className="px-8 py-5">
                            <span
                              className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm ${getCallStatusColor(log.callStatus)}`}
                            >
                              {log.callStatus}
                            </span>
                          </td>
