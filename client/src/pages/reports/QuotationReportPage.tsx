...
const QuotationReportPage: React.FC = () => {
  ...
  const stats = [
    {
      label: "Total Quotes",
      value: reportData?.stats?.total.toString() || "0",
      icon: FileSearch,
    ...
    {
      label: "Accepted",
      value: reportData?.stats?.accepted.toString() || "0",
      icon: CheckCircle,
    ...
    {
      label: "Waiting",
      value: reportData?.stats?.waiting.toString() || "0",
      icon: Clock,
    ...
    {
      label: "Rejected",
      value: reportData?.stats?.rejected.toString() || "0",
      icon: XCircle,
      color: "text-red-500",
      bg: "bg-red-50",
    },
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 font-medium">
              Tracking proposal success rates and conversion pipeline.
            </p>
          </div>
        </div>
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-slate-800">
                {(reportData?.quotations || []).map((quote: any, i: number) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-xs font-bold text-orange-500 uppercase tracking-widest">
                      {quote.validUntil}
                    </td>
                  </tr>
                ))}
