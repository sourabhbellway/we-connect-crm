          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setForm({ ...form, assignedTo: e.target.value ? Number(e.target.value) : "" })
                }
                className="w-full px-3 py-2 border rounded-lg bg-white dark:bg-gray-700"
              >
              ...
              {filteredTasks.map((task) => (
                ...
                >
                  <div className="p-4 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <h3
                      className={`text-sm font-bold text-gray-900 dark:text-white ${task.status === "COMPLETED" ? "line-through" : ""}`}
                    >
                      {task.title}
                    </h3>
                  </div>
                    ...
                    <div className="flex items-start gap-4 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-3 mb-2">
                          <h3
                            className={`text-base font-semibold ${task.status === "COMPLETED" ? "line-through text-gray-500 dark:text-gray-400" : "text-gray-900 dark:text-white"}`}
                          >
                            {task.title}
                          </h3>
                          <span
