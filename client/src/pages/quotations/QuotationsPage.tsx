...
import { FileCheck, Plus, Eye, Download, Filter, Search, Edit, Trash2, Send } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                  Manage and track your quotations • Showing {pagination.totalItems} quotation{pagination.totalItems !== 1 ? 's' : ''}
                </p>
              </div>
            </div>
            {hasPermission('deal.create') && (
              <Button
                ...
                className="bg-red-500 hover:bg-red-600 text-white px-6 py-3 rounded-lg flex items-center gap-2 font-medium shadow-lg hover:shadow-xl transition-all"
              >
                <Plus size={20} />
                Add Quotation
              </Button>
...
<div className="col-span-2 flex items-center justify-end gap-3 flex-shrink-0 pl-4 md:pl-6 min-w-[160px]">
        ...
        {pagination.totalPages > 1 && (
          <div className="mt-6 flex items-center justify-between bg-white dark:bg-gray-800 px-6 py-4 rounded-lg shadow-sm">
