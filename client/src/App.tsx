...
import WebhooksPage from './pages/business-settings/WebhooksPage';
...
import VoipSettingsPage from "./pages/business-settings/VoipSettingsPage";
        ...
        <>
            {isAuthenticated ? (
                <Routes>
                    ...
                    />
                    <Route
                        path="/business-settings/integrations/webhooks"
                        element={
                            <ProtectedRoute>
                                <MainLayout>
                                    <WebhooksPage />
