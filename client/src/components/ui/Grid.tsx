...
export const GridItem: React.FC<GridItemProps> = ({
  ...
  return <div className={`${spanClass} ${offsetClass} ${className}`}>{children}</div>;
};
...
export const Column: React.FC<ColumnProps> = ({ children, className = "", width = 1 }) => {
  const widthStyle = {
...
export const Spacer: React.FC<SpacerProps> = ({ size = 1, direction = "vertical" }) => {
