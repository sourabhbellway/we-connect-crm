...
const SearchInput: React.FC<SearchInputProps> = ({
  ...
  return (
    <div className={`relative w-full ${className}`}>
      <Search className="input-icon pointer-events-none absolute start-4 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400 dark:text-gray-500" />
      <input
        ref={inputRef}
        type="text"
