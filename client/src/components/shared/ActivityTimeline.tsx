...
const ActivityTimeline: React.FC<ActivityTimelineProps> = ({ activities: initialActivities }) => {
            ...
            filteredActivities.map((activity) => {
              ...
              return (
                <div key={activity.id} className="relative flex items-start">
                  {/* Timeline Node */}
                  <div
                    className={`absolute left-0 w-12 h-12 rounded-full border-4 border-white dark:border-gray-800 ${colorClasses} flex items-center justify-center z-10`}
                  >
                    <Icon size={18} />
                  </div>
