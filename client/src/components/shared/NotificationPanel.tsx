            ...
            return (
              <Card
                ...
                className={`p-4 cursor-pointer hover:shadow-lg transition-shadow ${
                  !notification.isRead
                    ? "border-l-4 border-l-weconnect-red bg-blue-50/30 dark:bg-blue-900/10"
                    : ""
                }`}
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-1">
                          <h3
                            className={`text-base font-semibold ${!notification.isRead ? "text-gray-900 dark:text-white" : "text-gray-700 dark:text-gray-300"}`}
                          >
                            {notification.title}
                          </h3>
                        ...
                        <p
                          className={`text-sm mb-2 ${!notification.isRead ? "text-gray-700 dark:text-gray-300" : "text-gray-600 dark:text-gray-400"}`}
                        >
