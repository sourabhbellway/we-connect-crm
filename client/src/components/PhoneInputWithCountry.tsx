      ...
      <div className="relative">
        ...
        <div className={`flex items-stretch rounded-lg border ${
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 border-r border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors rounded-l-lg"
          >
