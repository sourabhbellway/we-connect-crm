    ...
    try {
      ...
      if (composeType === "EMAIL") {
        ...
        payload = {
          ...
          templateId:
            composeForm.useTemplate && composeForm.templateId
            ...
            <div className="flex justify-end">
              <button
                ...
                disabled={
                  ...
                  (composeType === "EMAIL" && !composeForm.subject.trim())
                }
                        ...
                        <div>
                          <div className="flex items-center space-x-2">
                            <h4 className="font-medium text-gray-900 dark:text-white">
                              {message.type} {message.direction === "OUTBOUND" ? "to" : "from"}{" "}
                              {lead.firstName}
                            </h4>
                            <span
                              className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getMessageStatusColor(message.status)}`}
                            >
