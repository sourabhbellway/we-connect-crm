                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex space-x-4">
                            <button
                                ...
                                disabled={!lead.email}
                                className={`flex items-center px-4 py-2 rounded-lg border transition-colors ${composeType === 'EMAIL'
                            ...
                            <button
                                ...
                                disabled={!lead.phone}
                                className={`flex items-center px-4 py-2 rounded-lg border transition-colors ${composeType === 'WHATSAPP'
                            ...
                            <button
                                ...
                                disabled={!lead.phone}
                                className={`flex items-center px-4 py-2 rounded-lg border transition-colors ${composeType === 'SMS'
