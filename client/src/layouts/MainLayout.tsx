  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-slate-950">
      ...
      <div
        ...
        } fixed md:relative md:translate-x-0 inset-y-0 left-0 z-50 flex flex-col ${
      ...
      >
        {/* Sidebar header */}
        <div
          className={`flex items-center ${sidebarCollapsed ? "justify-center px-2" : "justify-between px-6 md:px-4"} h-16 md:h-14 border-b border-gray-200 dark:border-slate-800`}
        >
          {!sidebarCollapsed && (
        ...
        <div className="border-t border-gray-200 dark:border-slate-800 p-4 md:p-3">
          <div className="relative" ref={userMenuRef}>
            ...
            >
              <div
                className={`flex items-center gap-3 md:gap-2 min-w-0 ${sidebarCollapsed ? "justify-center" : "flex-1"}`}
              >
            ...
            {userMenuOpen && !sidebarCollapsed && (
              <div className="absolute bottom-full left-0 right-0 mb-3 bg-white/95 dark:bg-slate-800/95 backdrop-blur-md rounded-2xl shadow-2xl border border-gray-200 dark:border-slate-700 z-[101] overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-200">
                <div className="py-1">
                  <button
                    onClick={() => {
                      navigate("/profile");
