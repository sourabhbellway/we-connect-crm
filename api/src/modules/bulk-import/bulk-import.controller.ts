...
export class BulkImportController {
  ...
  @Post('leads')
  createBatch(@Body() dto: CreateLeadImportBatchDto) { return this.service.createLeadBatch(dto); }
  ...
  listRecords(@Param('id') id: string) { return this.service.listRecords(Number(id)); }
}