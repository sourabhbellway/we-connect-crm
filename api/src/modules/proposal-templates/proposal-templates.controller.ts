...
export class ProposalTemplatesController {
  ...
  @Post()
  create(@Body() dto: UpsertProposalTemplateDto) { return this.service.create(dto); }

  @Put(':id')
  update(@Param('id') id: string, @Body() dto: UpsertProposalTemplateDto) { return this.service.update(Number(id), dto); }
