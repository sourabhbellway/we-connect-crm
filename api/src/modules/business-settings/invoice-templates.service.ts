      ...
      const defaults = [
        {
          ...
          description:
            'Clean modern layout with logo left, invoice details right.',
      ...
      for (const template of defaults) {
        await this.prisma.invoiceTemplate.create({
          data: {
            ...
            footerContent: '',
            termsAndConditions:
              'Parking charges will be applied if the vehicle is not collected within 3 days after completion of repairs.',
          },
        });
      }
