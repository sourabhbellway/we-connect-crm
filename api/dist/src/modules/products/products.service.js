        ...
        try {
            ...
            const product = await this.prisma.product.create({
                data: {
                    ...
                    unit: dto.unit ?? 'pcs',
                    taxRate: dto.taxRate !== undefined && dto.taxRate !== null
                        ? Number(dto.taxRate)
                        : null,
                    hsnCode: dto.hsnCode && String(dto.hsnCode).trim() !== ''
                        ? dto.hsnCode.trim()
                        : null,
    ...
    async update(id, dto) {
        try {
            ...
            if (dto.taxRate !== undefined) {
                updateData.taxRate =
                    dto.taxRate !== null ? Number(dto.taxRate) : null;
            }
            ...
            for (let i = 1; i < lines.length; i++) {
                try {
                    ...
                    await this.create({
                        ...
                        isActive: row.isactive?.toUpperCase() === 'YES' ||
