...
__decorate([
    (0, common_1.Get)(),
    (0, permission_decorator_1.RequirePermission)('deal.read'),
...
__decorate([
    (0, common_1.Post)(),
    (0, permission_decorator_1.RequirePermission)('deal.create'),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, permission_decorator_1.RequirePermission)('deal.update'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, permission_decorator_1.RequirePermission)('deal.delete'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
