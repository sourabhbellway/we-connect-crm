...
exports.DealsModule = DealsModule = __decorate([
    (0, common_1.Module)({
        imports: [notifications_module_1.NotificationsModule, automation_module_1.AutomationModule],
        controllers: [deals_controller_1.DealsController],
        providers: [deals_service_1.DealsService, prisma_service_1.PrismaService],
    })
], DealsModule);
