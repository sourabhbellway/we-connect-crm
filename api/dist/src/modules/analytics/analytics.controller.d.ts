...
export declare class AnalyticsController {
    ...
    kpis(startDate?: string, endDate?: string, userId?: string, scope?: string, user?: any): Promise<{
        success: boolean;
        data: {
            revenue: {
                total: number;
    ...
    getLeadStatusDistribution(userId?: string, scope?: string, user?: any): Promise<{
        success: boolean;
        data: {
            name: string;
            value: number;
    ...
    getRevenueTrends(months?: string, userId?: string, scope?: string, user?: any): Promise<{
        success: boolean;
        data: {
            name: string;
            revenue: number;
    ...
    getActivityTrends(months?: string, userId?: string, scope?: string, user?: any): Promise<{
        success: boolean;
        data: {
            name: string;
            activities: number;
    ...
    getLeadConversionFunnel(userId?: string, scope?: string, user?: any): Promise<{
        success: boolean;
        data: {
            name: string;
            value: number;
    ...
    getSalesPipelineFlow(months?: string, userId?: string, scope?: string, user?: any): Promise<{
        success: boolean;
        data: {
            name: string;
            new: number;
    ...
    getTopPerformers(limit?: string, userId?: string, scope?: string, user?: any): Promise<{
        success: boolean;
        data: {
            name: string;
            deals: number;
    ...
    getDealVelocity(months?: string, userId?: string, scope?: string, user?: any): Promise<{
        success: boolean;
        data: {
            name: string;
            avgDays: number;
    ...
    getLeadSourceDistribution(userId?: string, scope?: string, user?: any): Promise<{
        success: boolean;
        data: {
            name: string;
            total: number;
