...
exports.CommunicationsModule = CommunicationsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [
            communications_controller_1.CommunicationsController,
            webhooks_controller_1.WebhooksController,
            communication_providers_controller_1.CommunicationProvidersController,
        ],
        providers: [
            communications_service_1.CommunicationsService,
            communication_providers_service_1.CommunicationProvidersService,
