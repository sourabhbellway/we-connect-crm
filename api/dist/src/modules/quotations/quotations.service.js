...
let QuotationsService = class QuotationsService {
    ...
    async buildPdf(id) {
        ...
        return new Promise((resolve, reject) => {
            ...
            doc
                ...
                .text(companyName, leftCol, y);
            y += 25;
            doc.fontSize(8).font('Helvetica').fillColor(colors.text);
            if (bs?.companyAddress) {
                const addressLines = bs.companyAddress
                    .split(',')
                    .map((line) => line.trim());
            ...
            doc
                ...
                .text('Quotation No:', rightCol, rightY + 8);
            doc
                .fontSize(10)
                .font('Helvetica-Bold')
                .fillColor(colors.text)
                .text(quotation.quotationNumber, rightCol + 80, rightY + 8);
            ...
            doc
                ...
                .font('Helvetica-Bold')
                .fillColor(colors.lightText)
                .text('Quotation Date:', rightCol, rightY + 8);
            doc
                .fontSize(10)
                .font('Helvetica')
                .fillColor(colors.text)
                .text(new Date(quotation.createdAt).toLocaleDateString('en-GB', {
                day: '2-digit',
                month: 'short',
                year: 'numeric',
            ...
            doc
                ...
                .font('Helvetica-Bold')
                .fillColor(colors.lightText)
                .text('Valid Until:', rightCol, rightY + 8);
            ...
            doc
                ...
                .font('Helvetica')
                .fillColor(colors.text)
                .text(validDate, rightCol + 80, rightY + 8);
            ...
            doc
                ...
                .font('Helvetica-Bold')
                .fillColor(colors.primary)
                .text('BILLING DETAILS', leftCol + 10, y + 8);
            y += 30;
            ...
            doc
                ...
                .font('Helvetica-Bold')
                .fillColor(colors.primary)
                .text('Quotation By:', billingLeftCol, leftY);
            leftY += 15;
            doc
                .fontSize(9)
                .font('Helvetica-Bold')
                .fillColor(colors.text)
                .text(companyName, billingLeftCol, leftY);
            leftY += 12;
            doc.fontSize(8).font('Helvetica').fillColor(colors.text);
            if (bs?.companyAddress) {
                const addressLines = bs.companyAddress
            ...
            doc
                ...
                .font('Helvetica-Bold')
                .fillColor(colors.primary)
                .text('Quotation To:', billingRightCol, customerY);
            customerY += 15;
            ...
            doc
                ...
                .font('Helvetica-Bold')
                .fillColor(colors.text)
                .text(customerName, billingRightCol, customerY);
            customerY += 12;
            doc.fontSize(8).font('Helvetica').fillColor(colors.text);
            ...
            if (quotation.lead?.address) {
                const custAddressLines = quotation.lead.address
                    .split(',')
                    .map((line) => line.trim());
            ...
            if (quotation.title) {
                ...
                doc
                    ...
                    .font('Helvetica-Bold')
                    .fillColor(colors.text)
                    .text(`Subject: ${quotation.title}`, leftCol + 10, y + 5);
                y += 30;
            }
            const tableTop = y;
            doc.rect(leftCol, tableTop, 515, 25).fill(colors.primary);
            doc.fontSize(9).font('Helvetica-Bold').fillColor(colors.white);
            doc.text('S.No', leftCol + 5, tableTop + 8, {
                width: 25,
                align: 'center',
            });
            doc.text('Item Description', leftCol + 40, tableTop + 8);
            doc.text('Qty', leftCol + 285, tableTop + 8, {
                width: 35,
                align: 'center',
            });
            doc.text('Unit Price', leftCol + 325, tableTop + 8, {
                width: 90,
                align: 'right',
            });
            doc.text('Amount', leftCol + 420, tableTop + 8, {
                width: 90,
                align: 'right',
            });
            y = tableTop + 25;
            quotation.items.forEach((item, index) => {
                if (y > 650) {
                    ...
                    doc.text('Unit Price', leftCol + 325, y + 8, {
                        width: 90,
                        align: 'right',
                    });
                    doc.text('Amount', leftCol + 420, y + 8, {
                        width: 90,
                        align: 'right',
                    });
                    y += 25;
                ...
                doc
                    .rect(leftCol, y, 515, rowHeight)
                    .lineWidth(0.5)
                    .strokeColor(colors.border)
                    .stroke();
                doc.fontSize(8).font('Helvetica').fillColor(colors.text);
                doc.text(String(index + 1), leftCol + 5, y + 8, {
                    width: 25,
                    align: 'center',
                });
                doc.text(item.name, leftCol + 40, y + 8, { width: 240 });
                doc.text(String(item.quantity), leftCol + 285, y + 8, {
                    width: 35,
                    align: 'center',
                });
            ...
            doc
                .rect(totalsX - 15, y - 10, totalsLabelWidth + totalsValueWidth + 25, 110)
                .fill(colors.light);
            doc
                .rect(totalsX - 15, y - 10, totalsLabelWidth + totalsValueWidth + 25, 110)
                .lineWidth(1)
            ...
            doc
                .moveTo(totalsX - 10, y)
                .lineTo(totalsX + totalsLabelWidth + totalsValueWidth + 10, y)
                .lineWidth(0.5)
                .strokeColor(colors.border)
                .stroke();
            y += 10;
            doc
                .rect(totalsX - 10, y - 5, totalsLabelWidth + totalsValueWidth + 20, 25)
            ...
            doc
                ...
                .fillColor(colors.text)
                .text(`Amount in Words: ${amountInWords}`, leftCol, y);
            y += 30;
            if (quotation.terms) {
                doc.rect(leftCol, y, 515, 20).fill(colors.lightOrange);
                doc
                    ...
                    .font('Helvetica-Bold')
                    .fillColor(colors.primary)
                    .text('Terms and Conditions', leftCol + 10, y + 5);
                y += 25;
            ...
            if (quotation.notes) {
                ...
                doc
                    ...
                    .font('Helvetica-Bold')
                    .fillColor(colors.primary)
                    .text('Additional Notes', leftCol + 10, y + 5);
                y += 25;
                doc
                    .fontSize(8)
                    .font('Helvetica')
                    .fillColor(colors.text)
                    .text(quotation.notes, leftCol + 10, y, { width: 515, lineGap: 2 });
            ...
            doc
                ...
                .font('Helvetica-Bold')
                .fillColor(colors.primary)
                .text('Contact Information', leftCol, y + 30);
            doc
                .fontSize(8)
                .font('Helvetica')
                .fillColor(colors.text)
                .text(`Email: ${bs?.companyEmail || 'info@company.com'} | Phone: ${bs?.companyPhone || '+91-XXXXXXXXXX'}`, leftCol, y + 45);
            doc.text(`Website: ${bs?.companyWebsite || 'www.example.com'}`, leftCol, y + 60);
            doc
                .fontSize(12)
                .font('Helvetica-Bold')
                .fillColor(colors.secondary)
                .text('Thank you for your business!', 0, y + 45, {
                align: 'center',
                width: 595,
            });
            ...
            for (let i = range.start; i <= range.start + range.count - 1; i++) {
                ...
                doc
                    ...
                    .font('Helvetica')
                    .fillColor(colors.lightText)
                    .text(`Page ${i + 1} of ${range.start + range.count}`, 0, 820, {
                    align: 'center',
                    width: 595,
                });
            }
    ...
    async generateInvoice(id) {
        ...
        const invoice = await this.prisma.invoice.update({
            ...
            data: {
                invoiceNumber: `${invPrefix}${pad(createdInv.id, invPad)}${invSuffix} `,
            },
            include: { items: true },
        });
    ...
    async bulkImportFromCsv(file, userId) {
        try {
                ...
                try {
                    ...
                    if (!row.title || !row.totalamount) {
                        results.data.errors.push({
                            row: i + 1,
                            error: 'Missing required fields: title or totalAmount',
                        });
                        results.data.failed++;
                        continue;
                    }
            ...
            return {
                success: false,
                message: error.message || 'Failed to import quotations from CSV',
            };
        }
    }
};
