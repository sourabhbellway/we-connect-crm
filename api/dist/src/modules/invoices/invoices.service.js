            ...
            return new Promise((resolve, reject) => {
                ...
                const drawNotesAndTerms = (startY) => {
                    ...
                    if (invoice.notes) {
                        ...
                        doc
                            ...
                            .font('Helvetica')
                            .fillColor('#374151')
                            .text(invoice.notes, 40, currentY, { width: 515, lineGap: 2 });
                    ...
                    if (invoice.terms) {
                        ...
                        doc
                            ...
                            .font('Helvetica')
                            .fillColor('gray')
                            .text(invoice.terms, 40, currentY, { width: 515, lineGap: 1 });
                ...
                if (templateId === 'professional') {
                    ...
                    doc
                        ...
                        .font('Helvetica')
                        .fillColor('gray')
                        .text(`${invoice.invoiceNumber}`, 350, headerY + 35, {
                        align: 'right',
                    });
                    if (logoDrawn)
                        headerY += 80;
                    ...
                    doc
                        ...
                        .font('Helvetica-Bold')
                        .fillColor('#111827')
                        .text(companyName.toUpperCase(), leftX, headerY);
                    ...
                    if (gstNo && gstNo !== 'N/A') {
                        ...
                        doc
                            .fillColor(primaryColor)
                            .font('Helvetica-Bold')
                            .text(`GSTIN: ${gstNo}`, leftX + 5, leftY + 2);
                        leftY += 20;
                    }
                    if (panNo && panNo !== 'N/A') {
                        doc
                    ...
                    if (cinNo && cinNo !== 'N/A') {
                        doc
                            ...
                            .font('Helvetica')
                            .fillColor('gray')
                            .text(`CIN: ${cinNo}`, leftX, leftY);
                        leftY += 12;
                    }
                    const rightY = headerY;
                    const metaBoxX = 380;
                    ...
                    const drawMeta = (label, value, y, isLast = false) => {
                        doc
                            ...
                            .font('Helvetica-Bold')
                            .fillColor('gray')
                            .text(label.toUpperCase(), metaBoxX + 10, y + 10);
                        doc
                            .fontSize(10)
                            .font('Helvetica-Bold')
                            .fillColor('#111827')
                            .text(value, metaBoxX + 10, y + 25);
                        if (!isLast)
                            doc
                                .moveTo(metaBoxX, y + 42)
                                .lineTo(metaBoxX + 175, y + 42)
                                .strokeColor('#F3F4F6')
                                .stroke();
                    };
                    drawMeta('Date of Issue', new Date(invoice.createdAt).toLocaleDateString(), rightY);
                    drawMeta('Due Date', invoice.dueDate
                    ...
                    doc
                        ...
                        .font('Helvetica-Bold')
                        .fillColor(primaryColor)
                        .text('BILL TO', leftX + 10, billToY + 8);
                    let billY = billToY + 35;
                    doc
                        .fontSize(12)
                        .font('Helvetica-Bold')
                        .fillColor('#111827')
                        .text(customerName, leftX + 10, billY);
                    billY += 18;
                    doc.fontSize(9).font('Helvetica').fillColor('gray');
                    if (customerCompany) {
                    ...
                    doc.text('AMOUNT', cols.total.x, tableTop + 11, {
                    ...
                    invoice.items.forEach((item, idx) => {
                        ...
                        doc
                            .fillColor('#1F2937')
                            .font('Helvetica-Bold')
                            .text(item.name, cols.name.x + 10, rowY + 10);
                        if (item.description) {
                            doc
                                .fontSize(8)
                                .font('Helvetica')
                                .fillColor('gray')
                                .text(item.description, cols.name.x + 10, rowY + 22, {
                                width: cols.name.width - 20,
                                height: 20,
                                ellipsis: true,
                            });
                        }
                        doc.fontSize(9).font('Helvetica').fillColor('#111827');
                        doc.text(String(item.quantity), cols.qty.x, rowY + 12, {
                            width: cols.qty.width,
                            align: 'center',
                        });
                        ...
                        doc
                            .font('Helvetica-Bold')
                            .text(Number(item.totalAmount).toFixed(2), cols.total.x, rowY + 12, { width: cols.total.width, align: 'right' });
                        rowY += itemHeight;
                    });
                    rowY += 20;
                    if (rowY > 650) {
                    ...
                    const drawTotalRow = (label, value, isFinal = false) => {
                        doc
                            ...
                            .fillColor(isFinal ? '#111827' : 'gray')
                            .text(label, totalsX, rowY);
                        doc
                            .fontSize(isFinal ? 14 : 10)
                            .font('Helvetica-Bold')
                            .fillColor(isFinal ? primaryColor : '#111827')
                            .text(value, totalsX + 100, rowY, { width: 105, align: 'right' });
                        rowY += isFinal ? 30 : 20;
                    };
                    ...
                    doc
                        ...
                        .font('Helvetica')
                        .fillColor('gray')
                        .text(companyName.toUpperCase(), 0, centerStackY, {
                        align: 'center',
                    });
                    centerStackY += 20;
                    ...
                    doc
                        ...
                        .font('Helvetica-Bold')
                        .fillColor('#111827')
                        .text(customerName, 50, detailsY + 15);
                    let billY = detailsY + 32;
                    doc.fontSize(9).font('Helvetica').fillColor('gray');
                    if (customerAddress) {
                        doc.text(customerAddress, 50, billY, { width: colWidth });
                        billY +=
                            doc.heightOfString(customerAddress, { width: colWidth }) + 5;
                    }
                    if (customerPhone !== 'N/A') {
                    ...
                    doc
                        ...
                        .font('Helvetica-Bold')
                        .fillColor('gray')
                        .text('INVOICE INFO', 400, detailsY, { align: 'right' });
                    doc
                        .fontSize(10)
                        .font('Courier-Bold')
                        .fillColor('#111827')
                        .text(invoice.invoiceNumber, 400, detailsY + 15, {
                        align: 'right',
                    });
                    doc
                        .fontSize(9)
                        .font('Courier')
                        .fillColor('gray')
                        .text(`Date: ${new Date(invoice.createdAt).toLocaleDateString()}`, 400, detailsY + 30, { align: 'right' });
                    doc
                        .fillColor('#DC2626')
                        .text(`Due: ${invoice.dueDate ? new Date(invoice.dueDate).toLocaleDateString() : 'N/A'}`, 400, detailsY + 45, { align: 'right' });
                    ...
                    invoice.items.forEach((item) => {
                        ...
                        doc
                            ...
                            .font('Helvetica')
                            .fillColor('gray')
                            .text(item.description || '', 50, rowY + 12, {
                            width: 280,
                            height: 10,
                        });
                        doc
                            ...
                            .font('Courier')
                            .fillColor('#111827')
                            .text(String(item.quantity), 350, rowY, {
                            align: 'center',
                            width: 50,
                        });
                        doc
                            .font('Helvetica-Bold')
                            .text(Number(item.totalAmount).toFixed(2), 480, rowY, {
                            align: 'right',
                            width: 65,
                        });
                        doc
                    ...
                    doc
                        ...
                        .font('Helvetica-Bold')
                        .fillColor('gray')
                        .text('TOTAL AMOUNT', 400, rowY, { align: 'right', width: 145 });
                    doc
                        .fontSize(24)
                        .font('Helvetica-Bold')
                        .fillColor('#111827')
                        .text(`${invoice.currency} ${Number(invoice.totalAmount).toFixed(2)}`, 350, rowY + 15, { align: 'right', width: 195 });
                    ...
                    const leftOff = logoDrawn ? 100 : 30;
                    doc
                        .fontSize(18)
                        .font('Helvetica-Bold')
                        .fillColor('#111827')
                        .text(companyName, leftOff, headerY);
                    doc
                        .fontSize(9)
                        .font('Helvetica')
                        .fillColor('gray')
                        .text(companyAddress || '', leftOff, headerY + 22, { width: 250 });
                    doc
                        .fontSize(8)
                        .font('Helvetica-Bold')
                        .fillColor(accentColor)
                        .text('BILL TO', 400, headerY, { align: 'right' });
                    doc
                        .fontSize(11)
                        .font('Helvetica-Bold')
                        .fillColor('#111827')
                        .text(customerName, 350, headerY + 15, {
                        align: 'right',
                        width: 215,
                    });
                    doc
                        ...
                        .font('Helvetica')
                        .fillColor('gray')
                        .text(customerAddress || '', 350, headerY + 30, {
                        align: 'right',
                        width: 215,
                    });
                    const boxY = 150;
                    ...
                    doc
                        .fontSize(8)
                        .font('Helvetica')
                        .text('INVOICE NUMBER', 55, boxY + 15);
                    doc
                        .fontSize(14)
                        .font('Helvetica-Bold')
                        .text(invoice.invoiceNumber, 55, boxY + 30);
                    doc
                        .moveTo(250, boxY + 10)
                        .lineTo(250, boxY + 50)
                    ...
                    doc
                        .fontSize(8)
                        .font('Helvetica')
                        .text('DATE OF ISSUE', 270, boxY + 15);
                    doc
                        .fontSize(12)
                        .font('Helvetica-Bold')
                        .text(new Date(invoice.createdAt).toLocaleDateString(), 270, boxY + 30);
                    doc
                        .moveTo(420, boxY + 10)
                        .lineTo(420, boxY + 50)
                        .strokeColor('rgba(255,255,255,0.3)')
                    ...
                    invoice.items.forEach((item, idx) => {
                        ...
                        doc
                            .fillColor('#9CA3AF')
                            .text(String(idx + 1).padStart(2, '0'), 30, rowY, {
                            width: 30,
                            align: 'center',
                        });
                        doc
                            .fillColor('#111827')
                            .font('Helvetica-Bold')
                            .text(item.name, 70, rowY);
                        doc.text(String(item.quantity), 430, rowY, {
                            width: 40,
                            align: 'center',
                        });
                        doc.text(Number(item.totalAmount).toFixed(2), 490, rowY, {
                            width: 75,
                            align: 'right',
                        });
                        doc
                    ...
                    doc
                        ...
                        .font('Helvetica-Bold')
                        .fillColor('#9CA3AF')
                        .text('TOTAL DUE', 380, totalY + 15);
                    doc
                        .fontSize(24)
                        .font('Helvetica-Bold')
                        .fillColor(accentColor)
                        .text(`${invoice.currency} ${Number(invoice.totalAmount).toFixed(2)}`, 350, totalY + 30, { align: 'right', width: 215 });
                    drawNotesAndTerms(totalY + 70);
                }
                else if (templateId === 'classic-right' ||
                    ...
                    doc
                        ...
                        .font('Helvetica-Bold')
                        .fillColor(darkText)
                        .text(`# ${invoice.invoiceNumber}`, 40, 85);
                    ...
                    doc
                        ...
                        .font('Helvetica-Bold')
                        .fillColor(darkText)
                        .text(companyName.toUpperCase(), rightColX, companyY, {
                        align: 'right',
                        width: 205,
                    });
                    companyY += 20;
                    ...
                    if (companyAddress) {
                        doc.text(companyAddress, rightColX, companyY, {
                            align: 'right',
                            width: 205,
                        });
                    ...
                    if (companyPhone) {
                        doc.text(companyPhone, rightColX, companyY, {
                            align: 'right',
                            width: 205,
                        });
                        companyY += 12;
                    ...
                    if (companyEmail) {
                        doc.text(companyEmail, rightColX, companyY, {
                            align: 'right',
                            width: 205,
                        });
                        companyY += 12;
                    ...
                    if (gstNo && gstNo !== 'N/A') {
                        doc.text(`GSTIN: ${gstNo}`, rightColX, companyY, {
                            align: 'right',
                            width: 205,
                        });
                        companyY += 12;
                    ...
                    if (panNo && panNo !== 'N/A') {
                        doc.text(`PAN: ${panNo}`, rightColX, companyY, {
                            align: 'right',
                            width: 205,
                        });
                        companyY += 12;
                    ...
                    if (cinNo && cinNo !== 'N/A') {
                        doc.text(`CIN: ${cinNo}`, rightColX, companyY, {
                            align: 'right',
                            width: 205,
                        });
                    }
                    ...
                    doc
                        ...
                        .fontSize(10)
                        .font('Helvetica-Bold')
                        .text('INVOICE TO', 50, billSectionY + 8);
                    const clientY = billSectionY + 35;
                    doc
                        .fillColor(darkText)
                        .fontSize(12)
                        .font('Helvetica-Bold')
                        .text(customerName, 40, clientY);
                    ...
                    if (customerAddress) {
                        ...
                        clientAddrY +=
                            doc.heightOfString(customerAddress, { width: 300 }) + 5;
                    }
                    ...
                    doc.text('PRICE', colX.price, tableHeaderY + 8, {
                        width: 70,
                        align: 'right',
                    });
                    doc.text('QTY', colX.qty, tableHeaderY + 8, {
                        width: 40,
                        align: 'center',
                    });
                    doc.text('TOTAL', colX.total, tableHeaderY + 8, {
                        width: 75,
                        align: 'right',
                    });
                    ...
                    invoice.items.forEach((item, index) => {
                        if (rowY > 720) {
                            ...
                            doc.text('PRICE', colX.price, rowY + 8, {
                                width: 70,
                                align: 'right',
                            });
                            doc.text('QTY', colX.qty, rowY + 8, {
                                width: 40,
                                align: 'center',
                            });
                            doc.text('TOTAL', colX.total, rowY + 8, {
                                width: 75,
                                align: 'right',
                            });
                            rowY += 30;
                        ...
                        doc
                            .fillColor(darkText)
                            .text(item.name, colX.desc, rowY, { width: 280 });
                        ...
                        doc
                            .font('Helvetica-Bold')
                            .text(Number(item.totalAmount).toFixed(2), colX.total, rowY, {
                            width: 75,
                            align: 'right',
                        });
                        doc.font('Helvetica');
                    ...
                    doc
                        .fillColor(darkText)
                        .text(Number(invoice.subtotal).toFixed(2), totalsValX, rowY, {
                        align: 'right',
                        width: totalsWidth,
                    });
                    rowY += 20;
                    if (Number(invoice.taxAmount) > 0) {
                        doc
                            .fillColor(grayText)
                            .text('Tax:', totalsX, rowY, { align: 'right', width: 90 });
                        doc
                            .fillColor(darkText)
                            .text(Number(invoice.taxAmount).toFixed(2), totalsValX, rowY, {
                            align: 'right',
                            width: totalsWidth,
                        });
                        rowY += 20;
                    ...
                    if (Number(invoice.discountAmount) > 0) {
                        doc
                            .fillColor(grayText)
                            .text('Discount:', totalsX, rowY, { align: 'right', width: 90 });
                        doc
                            .fillColor('red')
                            .text(`- ${Number(invoice.discountAmount).toFixed(2)}`, totalsValX, rowY, { align: 'right', width: totalsWidth });
                        rowY += 20;
                    }
                    rowY += 10;
                    ...
                    doc
                        .fontSize(14)
                        .text(`${invoice.currency} ${Number(invoice.totalAmount).toFixed(2)}`, totalsValX, rowY + 3, { align: 'right', width: totalsWidth });
                    let footerY = rowY + 60;
                    if (footerY > 700) {
                        doc.addPage();
                        footerY = 50;
                    ...
                    doc
                        ...
                        .font('Helvetica-Bold')
                        .fillColor(primaryAccent)
                        .text('Payment Information', 40, footerY);
                    doc.fontSize(9).font('Helvetica').fillColor(grayText);
                    footerY += 20;
                    ...
                    doc
                        ...
                        .lineTo(530, sigY)
                        .lineWidth(1)
                        .strokeColor(grayText)
                        .stroke();
                    doc
                        .fontSize(9)
                        .font('Helvetica')
                        .fillColor(grayText)
                        .text('Authorized Signature', 380, sigY + 10, {
                        align: 'center',
                        width: 150,
                    });
                    ...
                    details.forEach(([label, value]) => {
                        ...
                        doc
                            .font('Helvetica')
                            .fillColor(textGray)
                            .text(value, 120, billY, { width: 220 });
                        billY += doc.heightOfString(value, { width: 220 }) + 3;
                    });
                    const metaY = headerY + 25;
                    const metaX = 380;
                    const drawMetaLine = (label, value, y) => {
                        ...
                        doc
                            .font('Helvetica')
                            .fillColor(textGray)
                            .text(value, metaX + 80, y, { align: 'right', width: 95 });
                    };
                    ...
                    doc
                        ...
                        .font('Helvetica-Bold')
                        .fillColor('black')
                        .text('Service Details:', 40, headerY);
                    headerY += 25;
                    ...
                    doc.text('Quantity', colX.qty, headerY + 7, {
                        width: 85,
                        align: 'center',
                    });
                    doc.text(`Rate(${invoice.currency})`, colX.rate, headerY + 7, {
                        width: 95,
                        align: 'right',
                    });
                    doc.text(`Total(${invoice.currency})`, colX.total, headerY + 7, {
                        width: 75,
                        align: 'right',
                    });
                    let rowY = headerY + 22;
                    ...
                    invoice.items.forEach((item, idx) => {
                        ...
                        doc.fillColor('black');
                        doc.text(String(idx + 1), colX.no, rowY + 8, {
                            width: 30,
                            align: 'center',
                        });
                        doc.text(item.name, colX.desc + 5, rowY + 8, {
                            width: 210,
                            height: 15,
                            ellipsis: true,
                        });
                        doc.text(String(item.quantity), colX.qty, rowY + 8, {
                            width: 85,
                            align: 'center',
                        });
                        doc.text(Number(item.unitPrice).toFixed(2), colX.rate, rowY + 8, {
                            width: 95,
                            align: 'right',
                        });
                        doc
                            .font('Helvetica-Bold')
                            .text(Number(item.totalAmount).toFixed(2), colX.total, rowY + 8, {
                            width: 75,
                            align: 'right',
                        });
                        doc.font('Helvetica');
                    ...
                    doc
                        ...
                        .font('Helvetica')
                        .fillColor(textGray)
                        .text('Subtotal', totalLabelX, rowY);
                    doc.text(Number(invoice.subtotal).toFixed(2), totalValX, rowY, {
                        width: 75,
                        align: 'right',
                    });
                    rowY += 18;
                    if (Number(invoice.taxAmount) > 0) {
                        ...
                        doc.text(Number(invoice.taxAmount).toFixed(2), totalValX, rowY, {
                            width: 75,
                            align: 'right',
                        });
                        rowY += 18;
                    ...
                    doc
                        ...
                        .font('Helvetica-Bold')
                        .fillColor('black')
                        .text('Total Amount Due', totalLabelX, rowY);
                    doc
                        .fontSize(12)
                        .text(`${invoice.currency} ${Number(invoice.totalAmount).toFixed(2)} `, totalValX - 25, rowY, { width: 100, align: 'right' });
                    doc
                        .moveTo(totalLabelX, rowY + 18)
                        .lineTo(555, rowY + 18)
                        .stroke('#E5E7EB');
                    let termsY = rowY - 60;
                    ...
                    doc
                        ...
                        .font('Helvetica-Bold')
                        .fillColor('black')
                        .text('Terms and Conditions:', 40, termsY);
                    termsY += 18;
                    const termsList = [
                    ...
                    doc
                        ...
                        .font('Helvetica-Bold')
                        .fillColor('white')
                        .text('Payment Information:', 50, rowY + 8);
                    rowY += 35;
                    doc.fontSize(9).font('Helvetica-Bold').fillColor('black');
                    ...
                    doc
                        .font('Helvetica')
                        .fillColor(textGray)
                        .text('Bank Transfer', 120, rowY);
                    rowY += 15;
                    doc
                        .font('Helvetica-Bold')
                        .fillColor('black')
                        .text('Due Date:', 40, rowY);
                    doc
                        .font('Helvetica')
                        .fillColor(textGray)
                        .text(invoice.dueDate
                    ...
                    if (bs?.description && bs.description.includes('accountNumber')) {
                        try {
                            ...
                            doc
                                .font('Helvetica-Bold')
                                .fillColor('black')
                                .text('Bank Account:', 40, rowY);
                            doc
                                .font('Helvetica')
                                .fillColor(textGray)
                                .text(`${bank.bankName || ''} - ${bank.accountNumber || ''} `, 120, rowY);
                        }
                        catch { }
                    }
                    else {
                        ...
                        doc
                            .font('Helvetica')
                            .fillColor(textGray)
                            .text('1234-5678-9012-3456', 120, rowY);
                    }
                    doc
                        .fontSize(10)
                        .font('Helvetica-Bold')
                        .fillColor('black')
                        .text(`Date: ${new Date(invoice.createdAt).toLocaleDateString()} `, 400, rowY - 15);
                    rowY += 40;
                    ...
                    doc
                        .font('Helvetica')
                        .fillColor(textGray)
                        .text(companyEmail || 'N/A', 90, rowY);
                    rowY += 13;
                    doc
                        .font('Helvetica-Bold')
                        .fillColor('black')
                        .text('Call US:', 40, rowY);
                    doc
                        .font('Helvetica')
                        .fillColor(textGray)
                        .text(companyPhone || 'N/A', 90, rowY);
                    const signatureX = 400;
                    doc
                        .moveTo(signatureX, rowY)
                        .lineTo(signatureX + 130, rowY)
                        .lineWidth(0.5)
                        .stroke('#E5E7EB');
                    doc
                        .fontSize(10)
                        .font('Helvetica-Bold')
                        .fillColor(navyColor)
                        .text(companyName, signatureX, rowY - 25, {
                        width: 130,
                        align: 'center',
                    });
                    doc
                        ...
                        .font('Helvetica')
                        .fillColor(textGray)
                        .text('Authorised Signature', signatureX, rowY + 5, {
                        width: 130,
                        align: 'center',
                    });
                    doc
                    ...
                    doc
                        ...
                        .font('Helvetica-Bold')
                        .fillColor(primaryColor)
                        .text('INVOICE', 350, 25, { align: 'right', characterSpacing: 1 });
                    doc
                        .fontSize(10)
                        .font('Helvetica')
                        .fillColor('#4B5563')
                        .text(`# ${invoice.invoiceNumber} `, 350, 55, { align: 'right' });
                    headerY = 100;
                    doc
                        .fontSize(12)
                        .font('Helvetica-Bold')
                    ...
                    doc
                        ...
                        .font('Helvetica-Bold')
                        .fillColor(primaryColor)
                        .text('BILL TO', billX, headerY);
                    doc
                        .fontSize(11)
                        .font('Helvetica-Bold')
                        .fillColor('#111827')
                        .text(customerName, billX, headerY + 15);
                    ...
                    doc.text('QTY', colSetup.qty.x, tableTop + 6, {
                        width: colSetup.qty.width,
                        align: 'center',
                    });
                    doc.text('TOTAL', colSetup.total.x, tableTop + 6, {
                        width: colSetup.total.width,
                        align: 'right',
                    });
                    ...
                    invoice.items.forEach((item, idx) => {
                        ...
                        doc.text(String(item.quantity), colSetup.qty.x, rowY + 8, {
                            width: colSetup.qty.width,
                            align: 'center',
                        });
                        doc
                            .font('Helvetica-Bold')
                            .text(Number(item.totalAmount).toFixed(2), colSetup.total.x - 10, rowY + 8, { width: colSetup.total.width, align: 'right' });
                        doc.font('Helvetica');
                        doc
                            .moveTo(leftX, rowY + 25)
                            .lineTo(555, rowY + 25)
                            .strokeColor('#F3F4F6')
                            .stroke();
                        rowY += 25;
                    ...
                    doc
                        ...
                        .font('Helvetica-Bold')
                        .fillColor('gray')
                        .text('TOTAL DUE', 350, rowY, { align: 'right', width: 100 });
                    doc
                        .fontSize(16)
                        .font('Helvetica-Bold')
                        .fillColor(primaryColor)
                        .text(`${invoice.currency} ${Number(invoice.totalAmount).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} `, 450, rowY - 5, { align: 'right', width: 105 });
                    drawNotesAndTerms(rowY + 40);
                }
                const footerY = 750;
                doc.fontSize(8).font('Helvetica').fillColor('#9CA3AF');
                doc.text('Thank you for your business!', 30, footerY, {
                    align: 'center',
                    width: 535,
                });
                if (companyEmail)
                    doc.text(companyEmail, 30, footerY + 12, {
                        align: 'center',
                        width: 535,
                    });
                doc.end();
