            ...
            const items = [
                {
                    ...
                    totalAmount: Number(createdProducts[0].price) *
                        (1 + (Number(createdProducts[0].taxRate) || 0) / 100),
                    sortOrder: 1,
                },
            ];
            ...
            const items = [
                {
                    ...
                    totalAmount: Number(createdProducts[1].price) *
                        (1 + (Number(createdProducts[1].taxRate) || 0) / 100),
                    sortOrder: 1,
                },
            ];
            for (const item of items) {
