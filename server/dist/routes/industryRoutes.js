...
router.post("/industries", auth_1.authenticateToken, (0, auth_1.requireRole)("Admin"), industryValidators_1.createIndustryValidation, industryController_1.createIndustry);
router.put("/industries/:id", auth_1.authenticateToken, (0, auth_1.requireRole)("Admin"), industryValidators_1.updateIndustryValidation, industryController_1.updateIndustry);
router.delete("/industries/:id", auth_1.authenticateToken, (0, auth_1.requireRole)("Admin"), industryValidators_1.deleteIndustryValidation, industryController_1.deleteIndustry);
