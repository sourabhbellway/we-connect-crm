...
export declare const allowSelfOrPermission: (permissionKey: string, paramKey?: string) => (req: AuthenticatedRequest, res: Response, next: NextFunction) => void | Response<any, Record<string, any>>;
export {};
