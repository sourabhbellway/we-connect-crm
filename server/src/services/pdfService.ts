      ...
      try {
        ...
        data.items.forEach((item, index) => {
          ...
          doc.text(
            ...
            xPos + 5,
            yPos,
            { width: columnWidths[1] - 10, align: "right" }
          );
          xPos += columnWidths[1];

          // Unit Price
          doc.text(
            this.formatCurrency(item.unitPrice, data.quotation.currency),
            xPos + 5,
            yPos,
          ...
          doc
            ...
            .font("Helvetica-Bold")
            .text(
              this.formatCurrency(item.totalAmount, data.quotation.currency),
              xPos + 5,
              yPos,
              { width: columnWidths[5] - 10, align: "right" }
            );
        ...
        doc
          ...
          .font("Helvetica-Bold")
          .text(
            this.formatCurrency(data.quotation.subtotal, data.quotation.currency),
            totalsX + 150,
            yPos,
        ...
        if (data.quotation.discountAmount > 0) {
          ...
          doc
            ...
            .font("Helvetica-Bold")
            .text(
              `-${this.formatCurrency(data.quotation.discountAmount, data.quotation.currency)}`,
              totalsX + 150,
              yPos,
              { width: 100, align: "right" }
            );
        ...
        if (data.quotation.taxAmount > 0) {
          ...
          doc
            ...
            .font("Helvetica-Bold")
            .text(
              this.formatCurrency(data.quotation.taxAmount, data.quotation.currency),
              totalsX + 150,
              yPos,
              { width: 100, align: "right" }
            );
        ...
        doc
          .fontSize(16)
          .text(
            this.formatCurrency(data.quotation.totalAmount, data.quotation.currency),
            totalsX + 150,
            yPos + 5,
        ...
        doc
          ...
          .font("Helvetica")
          .text(
            `Generated on ${this.formatDate(new Date())} | ${data.company.companyName}`,
            leftMargin,
            footerY,
