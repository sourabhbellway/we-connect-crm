...
function Dashboard() {
  ...
  return (
    <div className="bg-[#EAEDF6] dark:bg-gray-900 min-h-screen">
      <div
        className="header bg-cover bg-center lg:flex justify-between items-center p-10 h-[27vh] relative"
      ...
      <div className="activity p-6">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
              ...
              <div className="flex items-center">
                ...
                <span className="text-xs text-gray-600 dark:text-gray-300">
                  ...
                  {isStatusLoading
                    ...
                    : systemStatus.api
                    ? `(ok${
                        latency.apiMs != null ? `, ${latency.apiMs}ms` : ""
                      })`
                    : "(down)"}
                </span>
              </div>
          ...
          <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4 max-h-82 overflow-y-auto">
              {isActivityLoading ? (
          ...
          {/* Activity Calendar */}
          <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 lg:col-span-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <div className="lg:col-span-2">
                <div className="grid grid-cols-7 text-[10px] font-medium text-gray-500 dark:text-gray-300 mb-2">
                  ...
                  {getMonthMatrix(currentMonth).map((cell, idx) => {
                    if (!cell)
                      return (
                        <div
                          key={idx}
                          className="h-14 rounded border border-dashed border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/20"
                        ></div>
                      );
                    ...
                    return (
                      <button
                        ...
                        className={`h-14 rounded border text-left p-1.5 transition-colors ${
                          isSelected
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          {count > 0 && (
                            <span className="text-[9px] px-1 py-0.5 rounded-full bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-200">
                              {count}
                            </span>
                          )}
                        </div>
                        <div className="mt-1 space-y-0.5 overflow-hidden">
                          {(todosByDate[key] || []).slice(0, 2).map((t) => (
                            <div
                              key={t.id}
                              className={`truncate text-[9px] rounded px-1 py-0.5 ${
                                t.done
