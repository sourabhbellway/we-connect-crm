...
import {  Users as UsersIcon, Mail, Calendar, Undo2, XCircle } from "lucide-react";
import BackButton from "./BackButton";

const dummyUsers = [
  { id: 1, firstName: "Alice", lastName: "Johnson", email: "alice@example.com", deletedAt: "2025-09-01 10:18" },
  { id: 2, firstName: "Bob", lastName: "Smith", email: "bob@example.com", deletedAt: "2025-09-02 08:12" },
  { id: 3, firstName: "Charlie", lastName: "Lee", email: "charlie@example.com", deletedAt: "2025-09-03 14:47" },
];
            ...
            <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              {dummyUsers.map((user) => (
                <tr key={user.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 flex items-center">
                    <Calendar className="h-3 w-3 mr-1" /> {user.deletedAt}
                  </td>
