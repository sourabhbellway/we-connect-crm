            ...
            <div className="relative bg-gray-200 dark:bg-gray-800 rounded-2xl hover:shadow-xl transition-all duration-300 p-6 sm:p-8 border border-gray-100 dark:border-gray-700">
                ...
                <div className="relative w-40 h-40 md:w-60 md:h-60">
                  ...
                  >
                    ...
                    <circle
                      ...
                      strokeWidth="4"
                    />
                    {/* Segment 1: Database - Purple (0 to 120 degrees) */}
                    <circle
                      cx="50"
                      cy="50"
                      r="40"
                      fill="none"
                      stroke={systemStatus.database ? "#a855f7" : "#ef4444"}
                      strokeWidth="4"
                      strokeDasharray="83.733 251.2"
                      strokeDashoffset="0"
                      strokeLinecap="round"
                    />
                    {/* Segment 2: API - Cyan/Teal (120 to 240 degrees) */}
                    <circle
                      cx="50"
                      cy="50"
                      r="40"
                      fill="none"
                      stroke={systemStatus.api ? "#06b6d4" : "#ef4444"}
                      strokeWidth="4"
                      strokeDasharray="83.733 251.2"
                      strokeDashoffset="-83.733"
                      strokeLinecap="round"
                    />
                    {/* Segment 3: Frontend - Lime/Green (240 to 360 degrees) */}
                    <circle
                      cx="50"
                      cy="50"
                      r="40"
              ...
              <div className="mt-4 lg:mt-0 lg:absolute lg:bottom-2 lg:left-6 lg:right-6">
                <div className="flex items-center">
                  <div
                    className={`w-2 h-2 rounded-full mr-2 ${systemStatus.database ? "bg-purple-500" : "bg-red-500"
                      }`}
                  ></div>
                ...
                <div className="flex items-center">
                  <div
                    className={`w-2 h-2 rounded-full mr-2 ${systemStatus.api ? "bg-cyan-500" : "bg-red-500"
                      }`}
                  ></div>
                  <span className="text-xs text-gray-600 dark:text-gray-300">
                    API SERVER{" "}
                ...
                <div className="flex items-center">
                  <div className="w-2 h-2 rounded-full mr-2 bg-lime-500"></div>
                  <span className="text-xs text-gray-600 dark:text-gray-300">
                    FRONTEND
                  </span>
                </div>
                ...
                {[
                  ...
                  <div key={idx} className={`p-4 rounded-lg ${kpi.bg} flex flex-col`}>
                    ...
                    <p className={`text-2xl font-bold ${kpi.color}`}>
                      {isKPILoading ? "..." : kpi.value.toLocaleString()}
                    </p>
                  </div>
                ))}
              </div>
