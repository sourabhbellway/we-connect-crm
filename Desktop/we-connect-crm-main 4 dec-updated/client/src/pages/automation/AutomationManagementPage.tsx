...
import { Zap, Plus, Play, Pause, Trash2, Clock, CheckCircle, XCircle, AlertCircle } from 'lucide-react';
...
const AutomationManagementPage: React.FC = () => {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {showBuilder && (
        <WorkflowBuilder onClose={() => setShowBuilder(false)} onSave={handleSaveWorkflow} />
      )}
    </div>
  );
};
